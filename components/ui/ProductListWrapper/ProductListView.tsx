...
export default function ProductListView({ category, subcategory }: Props) {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-6 xl:grid-cols-10 space-x-6'>
      ...
      <div className='lg:col-span-4 xl:col-span-8 overflow-y-auto min-h-screen gap-y-6 pt-4 lg:pt-10 lg:ml-4'>
