...
export default function CustomButton({
  ...
  return (
      ...
      className="relative  inline-flex overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer hover:bg-gray-100 items-center justify-center rounded-full bg-white px-6 py-2 text-base font-normal text-black backdrop-blur-3xl">
          {text}
        </span>
      </Link>
  )
